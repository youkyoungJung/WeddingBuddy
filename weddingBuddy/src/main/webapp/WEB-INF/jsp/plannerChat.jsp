						 ...
						 <a href="#"
							...
							<div class="contact-button">
									<button
										...
										onClick=location.href='<c:url value="/start"/>?to_id=${ChatWithUser.planner_id }&from_id=${info.user_id }'>Chat
									</button>
									<button
										class="btn btn-outline-light rounded-pill border-2 py-2 px-4 animated slideInRight"
										onClick=location.href='<c:url value="/review?planner_id=${planner.planner_id }"/>' >리뷰 쓰기</button>
