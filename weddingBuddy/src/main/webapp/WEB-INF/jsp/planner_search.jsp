			...
			<div class="container text-center">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb justify-content-center">
						<li class="breadcrumb-item"><a class="text-white" href="#">스튜디오</a></li>
						<li class="breadcrumb-item"><a class="text-white" href="#">메이크업</a></li>
						<li class="breadcrumb-item"><a class="text-white" href="#">웨딩홀</a></li>
					</ol>
				</nav>
			</div>
		</div>
