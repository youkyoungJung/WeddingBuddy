...
<body>
		...
		<ul class="top-nav-account">
			<c:if test="${!p_isLogin && !isLogin}">
				<li><a class="nav-link" href="<c:url value='/planner/login'/>"><i
						class="pe-7s-lock"></i>플래너 로그인/회원가입</a></li>
				<li><a class="nav-link" href="<c:url value='/login'/>"><i
						class="pe-7s-lock"></i>유저 로그인/회원가입</a></li>
			</c:if>
			<c:choose>
				<c:when test="${isLogin }">
					<li><a class="nav-link" href="<c:url value='/mypage'></c:url>">유저
							마이페이지</a></li>
					<li><a class="nav-link" href="<c:url value='/logout'/>"><i
							class="pe-7s-lock"></i>로그아웃</a></li>
				</c:when>
				<c:when test="${p_isLogin }">
					<li><a class="nav-link" href="<c:url value='/mypage'></c:url>">플래너
							마이페이지</a></li>
					<li><a class="nav-link" href="<c:url value='/logout'/>"><i
							class="pe-7s-lock"></i>로그아웃</a></li>
				</c:when>
	...
	<div style="height:3; background-color:#777; padding: 1px; margin:20;"></div>
