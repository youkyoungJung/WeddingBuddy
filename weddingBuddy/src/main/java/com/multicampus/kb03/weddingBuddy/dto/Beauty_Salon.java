...
public class Beauty_Salon {
	private int beauty_salon_id;
	private String name;
	...
	public String toString() {
		return "Beauty_salon [beauty_salon_id=" + beauty_salon_id + ", name=" + name + ", address=" + address
				+ ", phone=" + phone + ", price_range=" + price_range + ", company_unique_id=" + company_unique_id
				+ "]";
	}
	public int getBeauty_salon_id() {
		return beauty_salon_id;
	}
	public void setBeauty_salon_id(int beauty_salon_id) {
